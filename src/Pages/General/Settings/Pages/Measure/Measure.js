...
const Measure = () => {
  ...
  const editform = () => {
    ...
    console.log("UPDATE MEASURE", postDate);
    dataService.putexe(`unit/unit/${rowId}`, postDate)
      .then(response => {
        console.log("SUCCESS- UPDATED MEASURE", response.data);
        showToastMessage('UPDATE');
        initMeasure();
        setRowId(null);
      })
      .catch(error => {
        console.error("ERROR- UPDATED MEASURE", error);
      })
  }
  ...
  return (
    <div className="container-fluid mt-5">
      <div className="mb-3"><h5>Units of Measure</h5></div>
